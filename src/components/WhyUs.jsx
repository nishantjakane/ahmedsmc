...
function WhyUs(){
	...
	<h1 class="mb-8 text-center lg:text-4xl font-bold  whyUsHeading text-2xl py-6 mainHeading">Why Choose Us?</h1>
	...
	<ul class="grid place-content-center sm:grid-cols-2 gap-8 justify-center lg:px-96 text-center">
		<li class="flex">
			...
			<div>
				<p class="max-w-xs py-2 lg:text-xl  whyUsText text-white">You can join us because we are 3 years experienced trader we have our own session of 
		...
		<li class="flex">
			...
			<div>
				<p class="max-w-xs py-2 lg:text-xl 0 whyUsText text-white">We provide education too :: We prioritize your growth as a trader. Gain access to our comprehensive educational 
		...
		<li class="flex">
			...
			<div>
				<p class="max-w-xs py-2 lg:text-xl  whyUsText text-white">We recognize that every trader is unique. Receive personalized guidance and support that aligns with your goals, risk tolerance, and preferred trading style.
				</p>
			</div>
		</li>
		<li class="flex">
			...
			<div>
				<p class="max-w-xs py-2 lg:text-xl  whyUsText text-white">Our trading approach combines traditional techniques 
